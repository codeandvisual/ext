package com.codeandvisual.ext {
	public class Visual {
		...
		public static function drawPlane(thisGraphics:Graphics, bitmap:BitmapData, p1:Point, p2:Point, p3:Point, p4:Point) : void {
				...
				// Draws the triangle
				thisGraphics.clear();
				thisGraphics.beginBitmapFill(bitmap, null, false, true);
				
				thisGraphics.drawTriangles(
